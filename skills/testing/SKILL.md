...
## This project's own guide comes first
This skill is the generic standard. If the repo ships a `testing-guide-<project>` (generated by `/generate-test-guide`, listed in `docs/guidelines.md`'s routing table against the test-file pattern), load it too: it says what this project's seams, fakes, fixtures and commands actually are, and **where it disagrees with this skill, it wins** — it was written from the repo, this was not.
