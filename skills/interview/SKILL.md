---
name: interview
description: Relentlessly interview the user to elicit requirements before documenting. Use at the start of a feature or project, or on any "interview / grill / gather requirements" trigger.
---
...
Before asking, look up the answer in the environment: the code, the project docs (`docs/`, `CONTEXT.md`), and the tools available. Only *decisions* go to the user; *facts* you discover.
...
Ambiguity gate: do not conclude while any critical input above is undefined. Do not generate any document until the user confirms the shared understanding has been reached.
